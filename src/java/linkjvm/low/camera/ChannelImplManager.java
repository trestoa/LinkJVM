...
public class ChannelImplManager {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        linkjvm_cameraJNI.delete_ChannelImplManager(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setImage(SWIGTYPE_p_cv__Mat image) {
    linkjvm_cameraJNI.ChannelImplManager_setImage(swigCPtr, this, SWIGTYPE_p_cv__Mat.getCPtr(image));
  }

  public ChannelImpl channelImpl(SWIGTYPE_p_std__string name) {
    long cPtr = linkjvm_cameraJNI.ChannelImplManager_channelImpl(swigCPtr, this, SWIGTYPE_p_std__string.getCPtr(name));
