...
public class Motor {
	...
	private linkjvm.jni.motors.Motor jniMotor = null;
	...
	public void setPort(int port) throws InvalidPortException{
		...
		jniMotor = new linkjvm.jni.motors.Motor((short) port);
	}
	
	public void setJniMotor(linkjvm.jni.motors.Motor jniMotor){
		this.jniMotor = jniMotor;
	}
	
	public linkjvm.jni.motors.Motor getJniMotor(){
		return jniMotor;
	}
}
