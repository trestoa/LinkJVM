...
%typemap("javaimports") UnsignedIntRect2 "import linkjvm.low.geom.rectangle;";

%template(ChannelVector) std::vector<Camera::Channel*>;
%template(ObjectVector) std::vector<Camera::Object>;

%template(IntegerRectangle) Point2<unsigned int>;
%template(IntegerRectangle) Rect<unsigned int>;
